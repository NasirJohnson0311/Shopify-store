  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" style={{color: 'rgba(255, 255, 255, 0.6)'}}>
        ...
        <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" style={{color: 'rgba(255, 255, 255, 0.6)'}}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
