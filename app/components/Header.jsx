...
function SearchToggle() {
  const {open} = useAside();
  return (
    <button className="reset" onClick={() => open('search')} style={{display: 'inline-flex', alignItems: 'center', padding: 0, border: 'none', background: 'transparent', cursor: 'pointer'}}>
...
function CartBadge({count}) {
  ...
  return (
    <button
      ...
      className="reset"
      style={{display: 'inline-flex', alignItems: 'center', gap: '4px', verticalAlign: 'middle', padding: 0, border: 'none', background: 'transparent', cursor: 'pointer'}}
    >
